      ...
      <main className="flex-1 flex flex-col h-screen">
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 shrink-0">
          <div className="flex items-center gap-4">
            <button className="md:hidden text-slate-600" onClick={() => {}}>
            ...
            <div className="hidden md:flex items-center bg-slate-100 rounded-full px-4 py-1.5 border border-slate-200 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:bg-white transition-all">
              ...
              <input
                type="text"
                placeholder="Пошук учнів, класів або записів..."
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <div className="hidden lg:block text-left">
                <p className="text-xs font-bold text-slate-800 leading-none">Адміністратор</p>
        ...
        <div className="flex-1 p-6 md:p-8 overflow-y-auto bg-slate-50/30">
          {activeLesson && currentView === View.JOURNAL ? (
            <p className="text-xs text-slate-500 mb-4">Поточний урок: {activeLesson.title}</p>
          ) : null}
          {renderView()}
        </div>
      </main>
